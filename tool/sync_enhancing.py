...
def enhance_image(src_image_path, dst_image_path, h_flip, v_flip, hv_flip):
    ...
    if hv_flip:
        ...
        #print(os.path.splitext(dst_image_path)[0]+"-hv"+os.path.splitext(dst_image_path)[1], hv_flip)
...
if __name__ == "__main__":
    SRC = 'C:/carlos/image_download/data/special_handling_images'
    # dir for origin pics
    DST = 'C:/carlos/code/Image_Algorithm_Toolbox-master/Image_Algorithm_Toolbox-master/Enhancing_Tooldst_handling/handling'    # dir for generated pics
